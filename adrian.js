...
`.trim())
        ...
        switch (command) {
            ...
            break
            case 'Ds1':
AshiSinghy_pdf = await getBuffer(`https://mega.nz/folder/XiJgmR6S#TaDV5KZRoIlwbZ5D6e3_WA/file/3jwW2JZD`)
await conn.sendMessage(m.chat, { document: AshiSinghy_pdf, mimetype: '', fileName:`ladybug Season 2 EP 1` }, { quoted: m })     
break
case 'Ds2':
AshiSinghy_pdf2 = await getBuffer(`https://www.mediafire.com/file/kmspkvgyjtqs6py/SC-ADRIAN_MD.zip/file`)
await conn.sendMessage(m.chat, { document: AshiSinghy_pdf2, mimetype: '', fileName:`ladybug Season 2 EP 1` }, { quoted: m })     
break
            case 'ttc':
            case 'ttt':
            case 'tictactoe': {
